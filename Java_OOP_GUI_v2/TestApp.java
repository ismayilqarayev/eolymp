public class TestApp {
    public static void main(String[] args) {
        System.out.println("🧪 Testing Java OOP Student Management System v2...");
        ...
        // Create students
        Student student1 = new Student("Test Tələbə 1", 20, "1-ci kurs");
        Student student2 = new Student("Test Tələbə 2", 21, "2-ci kurs");
        ...
        System.out.println("✅ Student 1 GPA: " + String.format("%.2f", student1.getGpa()));
        System.out.println("✅ Student 2 GPA: " + String.format("%.2f", student2.getGpa()));
